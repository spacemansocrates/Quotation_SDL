...
function getSummaryData($conn) {
    $sql = "SELECT
        ...
        (SELECT COUNT(id) FROM inventory_stock WHERE quantity_in_stock <= minimum_stock_level AND minimum_stock_level > 0) as low_stock_count
    ";
...
function getLowStockItems($conn) {
    $sql = "SELECT
            ...
            WHERE inv.quantity_in_stock <= inv.minimum_stock_level AND inv.minimum_stock_level > 0
            ORDER BY (inv.minimum_stock_level - inv.quantity_in_stock) DESC
            LIMIT 5";
...
/**
 * Fetches the 5 most recent activities from the log.
 */
function getRecentActivity($conn) {
    $sql = "SELECT action_type, target_entity, description, timestamp
            FROM activity_log
...
<head>
    ...
    <title>BusinessOS Dashboard</title>
    <!-- Tailwind CSS CDN -->
...
<body class="flex h-screen">
    ...
    <aside class="w-64 bg-white border-r border-gray-200 flex-shrink-0">
        <div class="p-6">
            <h1 class="text-2xl font-bold text-gray-800">BusinessOS</h1>
        </div>
        <nav class="mt-6">
            <ul>
                <li>
                    <a href="#" class="flex items-center px-6 py-3 text-gray-700 bg-gray-100 font-semibold">
                        <svg class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z"></path></svg>
                        <span class="ml-3">Dashboard</span>
                    </a>
                </li>
                <li class="mt-4 px-6 text-xs uppercase font-semibold tracking-wider text-gray-500">Finance</li>
                <li><a href="#" class="flex items-center px-6 py-2 text-gray-600 hover:bg-gray-50"><span class="ml-9">Invoices</span></a></li>
                <li><a href="#" class="flex items-center px-6 py-2 text-gray-600 hover:bg-gray-50"><span class="ml-9">Quotations</span></a></li>
                <li><a href="#" class="flex items-center px-6 py-2 text-gray-600 hover:bg-gray-50"><span class="ml-9">Payments</span></a></li>

                <li class="mt-4 px-6 text-xs uppercase font-semibold tracking-wider text-gray-500">Inventory</li>
                <li><a href="#" class="flex items-center px-6 py-2 text-gray-600 hover:bg-gray-50"><span class="ml-9">Products</span></a></li>
                <li><a href="#" class="flex items-center px-6 py-2 text-gray-600 hover:bg-gray-50"><span class="ml-9">Stock Management</span></a></li>
                
                <li class="mt-4 px-6 text-xs uppercase font-semibold tracking-wider text-gray-500">Settings</li>
                <li><a href="#" class="flex items-center px-6 py-2 text-gray-600 hover:bg-gray-50"><span class="ml-9">Users</span></a></li>
                <li><a href="#" class="flex items-center px-6 py-2 text-gray-600 hover:bg-gray-50"><span class="ml-9">System Settings</span></a></li>
            </ul>
        </nav>
    </aside>
        ...
        <div class="px-6 lg:px-10 py-8">
            ...
            <header class="flex justify-between items-center mb-8">
                <div>
                    ...
                    <p class="text-gray-500">Welcome back, <?php echo htmlspecialchars(explode(' ', $user['full_name'])[0]); ?>! Here's your business overview.</p>
                </div>
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                    <div class="flex justify-between items-start">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-gray-800">$<?php echo number_format($summary['total_revenue'], 2); ?></p>
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start">
                            <?php
                                ...
                                $icon_svg = '<svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path></svg>'; // Default icon
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
                        ...
                        <table class="w-full text-sm text-left text-gray-500">
                            ...
                            <tbody>
                                ...
                                <tr class="bg-white border-b">
                                    <td class="py-4 px-4 font-medium text-gray-900"><?php echo htmlspecialchars($invoice['invoice_number']); ?></td>
                ...
                <div class="bg-white p-6 rounded-lg shadow">
                     <div class="flex justify-between items-center mb-4">
                        ...
                        <a href="#" class="text-sm text-blue-600 hover:underline">View inventory</a>
                    </div>
                     <div class="overflow-x-auto">
                        <table class="w-full text-sm text-left text-gray-500">
                            <thead class="text-xs text-gray-700 uppercase bg-gray-50">
    ...
    <!-- JAVASCRIPT SECTION -->
    <script>
        // Chart.js implementation for Revenue Overview
        const revenueData = {
            labels: <?php echo json_encode($chartData['labels']); ?>,
            datasets: [{
                label: 'Revenue',
                data: <?php echo json_encode($chartData['data']); ?>,
                backgroundColor: 'rgb(75, 85, 99)', // Corresponds to Tailwind's 'gray-600'
