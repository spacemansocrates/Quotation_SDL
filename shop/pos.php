...
<div class="categories">
    ...
    <?php
        // Look for the product's category in our map.
        // If it's found, use that icon. If not, use the default icon.
        $category_name = $product['category'];
        $icon_class = $category_icon_map[$category_name] ?? $default_product_icon;
    ?>
    <div class="product-card" data-id="<?php echo $product['id']; ?>" data-name="<?php echo htmlspecialchars($product['name']); ?>" data-price="<?php echo $product['price']; ?>" data-sku="<?php echo $product['sku']; ?>" data-icon="<?php echo $icon_class; ?>" data-category="<?php echo $product['category']; ?>">
        <div class="product-info">
            <i class="fas <?php echo $icon_class; ?> icon"></i>
