...
<body>
    <div class="container invoice-container"> 
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <h5 class="section-title">Invoice & Company Info</h5> 
        ...
        <?php else: ?>
            ...
            <tbody>
    <?php if (empty($invoice_items)): ?>
        <tr><td colspan="8" class="text-center">No items found for this invoice.</td></tr>
    <?php else: ?>
        <?php $item_counter = 1; // 1. Initialize the counter here ?>
        <?php foreach ($invoice_items as $item): ?>
            <tr>
                
                <!-- 2. Display the counter, not the database value -->
                ...
                <td><?php echo htmlspecialchars(number_format($item['quantity'] ?? 0, 2)); ?></td>
            ...
            <?php $item_counter++; // 3. Increment the counter for the next item ?>
        <?php endforeach; ?>
    <?php endif; ?>
</tbody>
            </table>
