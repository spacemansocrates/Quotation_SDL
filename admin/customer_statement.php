...
try {
    ...
    while ($row = $stmt_invoices_data->fetch(PDO::FETCH_ASSOC)) {
        // CHANGED: Round to 0 decimal places (nearest whole number)
        $balance_remaining_on_invoice = round($row['original_amount'] - $row['total_paid_as_of_date'], 0);
    ...
    <div class="statement-container">
        ...
        <div class="total-outstanding-section">
            ...
            <span class="highlight-balance">
                ...
                <span class="font-numeric"><?php echo htmlspecialchars(number_format($aging_summary['total_outstanding'], 0)); ?></span>
            </span>
        </div>
        ...
        <table class="items-table">
            ...
            <tbody>
                ...
                <?php else: ?>
                    ...
                    <tr class="<?php if($is_overdue_item) echo 'highlight-overdue'; ?>">
                        ...
                        <td class="number font-numeric"><?php echo htmlspecialchars(number_format($item['original_amount'], 0)); ?></td>
                        <td class="number font-numeric"><?php echo htmlspecialchars(number_format($item['amount_paid_on_doc'], 0)); ?></td>
                        <td class="number highlight-balance font-numeric"><?php echo htmlspecialchars(number_format($item['balance_on_doc'], 0)); ?></td>
                    </tr>
                    <?php endforeach; ?>
                <?php endif; ?>
            </tbody>
            <tfoot>
                <tr>
                    ...
                    <td class="number highlight-balance font-numeric"><?php echo $currency_symbol; ?> <?php echo htmlspecialchars(number_format($aging_summary['total_outstanding'], 0)); ?></td>
                </tr>
            </tfoot>
        </table>
        ...
        <table class="aging-table">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="number font-numeric"><?php echo htmlspecialchars(number_format($aging_summary['current'], 0)); ?></td>
                </tr>
                <tr>
                    <td>1 – 30 Days Overdue</td>
                    <td class="number font-numeric"><?php echo htmlspecialchars(number_format($aging_summary['0–30'], 0)); ?></td>
                </tr>
                <tr>
                    <td>31 – 60 Days Overdue</td>
                    <td class="number font-numeric"><?php echo htmlspecialchars(number_format($aging_summary['31–60'], 0)); ?></td>
                </tr>
                <tr>
                    <td>61 – 90 Days Overdue</td>
                    <td class="number font-numeric"><?php echo htmlspecialchars(number_format($aging_summary['61–90'], 0)); ?></td>
                </tr>
                <tr>
                    <td>Over 90 Days Overdue</td>
                    <td class="number font-numeric"><?php echo htmlspecialchars(number_format($aging_summary['Over 90'], 0)); ?></td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
                    <td style="text-align:right; font-weight:bold;">TOTAL OUTSTANDING:</td>
                    <td class="number highlight-balance font-numeric"><?php echo htmlspecialchars(number_format($aging_summary['total_outstanding'], 0)); ?></td>
                </tr>
            </tfoot>
        </table>
